...
INSERT INTO SmartTransit.Users (name, email, password, phone) VALUES
...
INSERT INTO SmartTransit.Routes (startPoint, endPoint, transportType, scheduleId) VALUES
('Station A', 'Station B', 'Bus', 1),
('Station C', 'Station D', 'Train', 2);

-- Insert sample data into SmartTransit.Schedules
INSERT INTO SmartTransit.Schedules (routeId, departureTime, arrivalTime, frequency) VALUES
...
INSERT INTO SmartTransit.Tickets (userId, routeId, purchase, qrCode, status) VALUES
(1, 1, '2024-10-07', 'QR123456789', 'Active'),
(2, 2, '2024-10-07', 'QR987654321', 'Active');

-- Insert sample data into SmartTransit.Payments
INSERT INTO SmartTransit.Payments (userId, ticketId, amount, Paymentscol, status, date) VALUES
